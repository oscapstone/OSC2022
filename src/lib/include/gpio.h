...
#define __GPIO__H__
#include "mmio.h"
#define GPIO_BASE_ADDRESS (0x00200000)
#define GPFSEL0   (MMIO_BASE_ADDRESS + GPIO_BASE_ADDRESS + 0x00)
#define GPFSEL1   (MMIO_BASE_ADDRESS + GPIO_BASE_ADDRESS + 0x04)
#define GPFSEL2   (MMIO_BASE_ADDRESS + GPIO_BASE_ADDRESS + 0x08)
#define GPFSEL3   (MMIO_BASE_ADDRESS + GPIO_BASE_ADDRESS + 0x0C)
#define GPFSEL4   (MMIO_BASE_ADDRESS + GPIO_BASE_ADDRESS + 0x10)
#define GPFSEL5   (MMIO_BASE_ADDRESS + GPIO_BASE_ADDRESS + 0x14)
#define GPSET0    (MMIO_BASE_ADDRESS + GPIO_BASE_ADDRESS + 0x1C)
#define GPSET1    (MMIO_BASE_ADDRESS + GPIO_BASE_ADDRESS + 0x20)
#define GPCLR0    (MMIO_BASE_ADDRESS + GPIO_BASE_ADDRESS + 0x28)
#define GPCLR1    (MMIO_BASE_ADDRESS + GPIO_BASE_ADDRESS + 0x2C)
#define GPLEV0    (MMIO_BASE_ADDRESS + GPIO_BASE_ADDRESS + 0x34)
#define GPLEV1    (MMIO_BASE_ADDRESS + GPIO_BASE_ADDRESS + 0x38)
#define GPEDS0    (MMIO_BASE_ADDRESS + GPIO_BASE_ADDRESS + 0x40)
#define GPEDS1    (MMIO_BASE_ADDRESS + GPIO_BASE_ADDRESS + 0x44)
#define GPREN0    (MMIO_BASE_ADDRESS + GPIO_BASE_ADDRESS + 0x4C)
#define GPREN1    (MMIO_BASE_ADDRESS + GPIO_BASE_ADDRESS + 0x50)
#define GPFEN0    (MMIO_BASE_ADDRESS + GPIO_BASE_ADDRESS + 0x58)
#define GPFEN1    (MMIO_BASE_ADDRESS + GPIO_BASE_ADDRESS + 0x5C)
#define GPHEN0    (MMIO_BASE_ADDRESS + GPIO_BASE_ADDRESS + 0x64)
#define GPHEN1    (MMIO_BASE_ADDRESS + GPIO_BASE_ADDRESS + 0x68)
#define GPLEN0    (MMIO_BASE_ADDRESS + GPIO_BASE_ADDRESS + 0x70)
#define GPLEN1    (MMIO_BASE_ADDRESS + GPIO_BASE_ADDRESS + 0x74)
#define GPAREN0   (MMIO_BASE_ADDRESS + GPIO_BASE_ADDRESS + 0x7C)
#define GPAREN1   (MMIO_BASE_ADDRESS + GPIO_BASE_ADDRESS + 0x80)
#define GPAFEN0   (MMIO_BASE_ADDRESS + GPIO_BASE_ADDRESS + 0x88)
#define GPAFEN1   (MMIO_BASE_ADDRESS + GPIO_BASE_ADDRESS + 0x8C)
#define GPPUD     (MMIO_BASE_ADDRESS + GPIO_BASE_ADDRESS + 0x94)
#define GPPUDCLK0 (MMIO_BASE_ADDRESS + GPIO_BASE_ADDRESS + 0x98)
#define GPPUDCLK1 (MMIO_BASE_ADDRESS + GPIO_BASE_ADDRESS + 0x9C)
