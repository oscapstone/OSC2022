...
#define CORE0_IRQ_SOURCE (IO_BASE + 0x1000060)
#define CORE1_IRQ_SOURCE (IO_BASE + 0x1000064)
#define CORE2_IRQ_SOURCE (IO_BASE + 0x1000068)
#define CORE3_IRQ_SOURCE (IO_BASE + 0x100006C)
#define CORE0_FIQ_SOURCE (IO_BASE + 0x1000070)
#define CORE1_FIQ_SOURCE (IO_BASE + 0x1000074)
#define CORE2_FIQ_SOURCE (IO_BASE + 0x1000078)
#define CORE3_FIQ_SOURCE (IO_BASE + 0x100007C)
