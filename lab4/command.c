...
void command_help ()
{
    ...
    uart_puts("reboot:\treserved\n");
    uart_puts("kernel_load:\treserved\n");
    uart_puts("ls:\treserved\n");
    uart_puts("cat:\treserved\n");
    uart_puts("load:\treserved\n");
    uart_puts("asycn:\treserved\n");
    uart_puts("alloc_test:\treserved\n");
    uart_puts("info:\treserved\n");
    uart_puts("state:\treserved\n");
    uart_puts("test_buddy:\treserved\n");
    uart_puts("\n");
}
